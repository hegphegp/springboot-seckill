...
public class SeckillQueue {
    ...
    /** 用于多线程间下单的队列 */
    static BlockingQueue<Record> blockingQueue = new LinkedBlockingQueue<Record>(QUEUE_MAX_SIZE);
     ...
     */
    public Boolean produce(Record kill) throws InterruptedException {
     ...
     */
    public Record consume() throws InterruptedException {
